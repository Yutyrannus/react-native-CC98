...
const script = `<script>window.location.hash = 1;document.title = document.height;console.warn('aa');</script>`
  ...
  render() {
    ...
    return (
      <WebView
        ...
        source={{html: htmlSource + script}}
        onLoadEnd={this.onNavigationStateChange.bind(this)} />
    );
  }
}
